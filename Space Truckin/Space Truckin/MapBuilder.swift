...
class Map {
    ...
    let cockPit: SKSpriteNode! = SKSpriteNode(imageNamed: "cockpit2")
...
/*
 stuff to save remove this area if empty
 267
 ...
 else if !name.contains("sectorMap") {
     touchedButton = false
 }
 ...
 dont forget to put pictures in place!
